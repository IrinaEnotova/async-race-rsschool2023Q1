...
export const PARAMS_HEADER_BTNS: IBasicElementParams = {
  tagName: 'div',
  classNames: ['header_btns-container'],
  parentSelector: 'header',
};

export const PARAMS_HEADING: IBasicElementParams = {
  tagName: 'h1',
...
export const PARAMS_BTN_GARAGE: IBasicElementParams = {
  tagName: 'button',
  textContent: 'Garage',
...
export const PARAMS_BTN_WINNERS: IBasicElementParams = {
  tagName: 'button',
  textContent: 'Winners',
